...
class TRICHU_Counter():
    def __init__(self,master):
        ...
        self.scoremenu.add_command(label = "Player 1",accelerator = 'Ctrl+p',command = self.player1score)
        self.scoremenu.add_command(label = "Player 2",accelerator = 'Ctrl+t',command = self.player2score)
        self.scoremenu.add_command(label = "Player 3",accelerator = 'Ctrl+j',command = self.player3score)
